const faqs = [
    {
        ...
        answer:'웹퍼블리싱 및 프론트엔드 개발에 필요한 실무 기술을 다룹니다.'
    },
    {
...
//p태그를 만들어서 추가하는 함수
const createElem_ptag = (txt,className) =>{
...
faqs.forEach((list)=>{
    ...
    // aElem.className = 'anwser';
    // liElem.append(qElem);
    // liElem.append(aElem);
    //대답 p태그에게 click 이벤트 처리 
    const qElem =createElem_ptag(list.question,'question');
    const aElem =createElem_ptag(list.answer,'anwser');
